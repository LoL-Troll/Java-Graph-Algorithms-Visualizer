...
public class ShortestPath {
  ...
  public static String start(
    ...
    return sb.append("\n[Shortest Path]\n\n")
        .append(generatePath(digraph, startVertex, endVertex, d, graphView))
        .append("\nWeight count from ")
        .append(startVertex)
        .append(" to ")
        .append(endVertex)
   ...
   * between the starting vertex and the ending vertex through array weight. This is also to detect
   * whether a path exists between the starting and ending vertices and return boolean value. This
   * should be called repeatedly by <code>
  ...
  private static boolean dijkstra(
      ...
      Vertex<String> startVertex,
      Vertex<String> endVertex,
      LinkedHashMap<Vertex<String>, Integer> d,
      int[] weight) {
    ...
    // for each vertex of the graph, add an entry to the priority queue with the source having
    ...
    // check if there is any path can be reach by starting vertex to ending vertex and return a
    // boolean value
   ...
   * or vertices on the path from starting vertex to ending vertex. This should be called repeatedly
   * by <code>start(AdjacencyMapDigraph, SmartGraphPanel, Vertex<String>, Vertex<String>)</code>.
   *
   * @param digraph Directed graph
   * @param startVertex Starting vertex of the shortest path algorithm
   * @param endVertex Ending vertex of the shortest path algorithm
